...
.factory('User', function($http) {
    ...
    //lock User
    userFactory.lockUser =function (username) {
        return $http.get('/api/lockuser/'+username);
    }
    //unlock user
    userFactory.unlockUser =function (username) {
        return $http.get('/api/unlockuser/'+username);
    }
    ...
    userFactory.sendSearchForm= function(searchdata){
        return $http.get('/api/searchnews',searchdata);
    }
